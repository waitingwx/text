...
import com.wx.kdxfdemo.speech.setting.IatSettings;
import com.wx.kdxfdemo.speech.util.JsonParser;

import java.util.HashMap;
import java.util.LinkedHashMap;

public class RecognizeActivity extends AppCompatActivity implements Istatus{
    ...
    private void initViews() {
        ...
        mResultText = ((EditText)findViewById(R.id.et_recog_result));
    ...
    private void startRecog() {
        ...
        btnStatus.setText(R.string.btn_status_stop);
    }
    /**
     * 参数设置
     * @return
